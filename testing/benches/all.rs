...
quis lacus at, gravida maximus elit. Duis tristique, nisl nullam.
    ...
    b.iter(|| {
        format!("{}", ::askama::MarkupDisplay::from(string_long));
        format!("{}", ::askama::MarkupDisplay::from(string_short));
        format!("{}", ::askama::MarkupDisplay::from(empty));
        format!("{}", ::askama::MarkupDisplay::from(no_escape));
        format!("{}", ::askama::MarkupDisplay::from(no_escape_long));
    });
}
